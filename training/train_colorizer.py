    ...
    try:
        ...
        for epoch in range(start_epoch, args.epochs):
            ...
            for step, (l_channel, ab_target) in enumerate(loader, start=1):
                ...
                loss = l1_loss + args.perceptual_weight * p_loss
                loss.backward()
            ...
            stats = torch.tensor([running_loss, running_l1_loss, running_perceptual_loss], device=device)
            ...
            if rank == 0:
                print(
                    ...
                    f"(L1: {avg_l1_loss:.6f}, P: {avg_perceptual_loss:.6f}) | Time: {epoch_time:.1f}s"
                )
